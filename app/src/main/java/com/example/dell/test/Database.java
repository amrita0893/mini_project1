...
public class Database extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME + " ( " +
            ...
            STUDENT_COLLEGE + " TEXT, " +
             STUDENT_PHONE_NUMBER + " INTEGER, "  + STUDENT_FEES + " INTEGER ); ";
    ...
    public long addNewStudent(Student student) {
        ...
        contentValues.put(STUDENT_COLLEGE, student.collegeName);
        contentValues.put(STUDENT_PHONE_NUMBER, student.phoneNumber);
        contentValues.put(STUDENT_FEES, student.fees);
    ...
    public Student getSingleStudentDetails(long id) {
        ...
        Cursor cursor = sqLiteDatabase.query(TABLE_NAME, new String[]{STUDENT_ID, STUDENT_NAME, STUDENT_COLLEGE,
                        STUDENT_PHONE_NUMBER,STUDENT_FEES}, STUDENT_ID + "=?", new String[]{String.valueOf(id)}, null, null,
                null, null);
        ...
        Student student = new Student(cursor.getInt(cursor.getColumnIndex(STUDENT_ID)),
             ...
             cursor.getLong(cursor.getColumnIndex(STUDENT_PHONE_NUMBER))  ,   cursor.getInt(cursor.getColumnIndex(STUDENT_FEES)));
    ...
    public List<Student> allStudentsDetails() {
        ...
        if (cursor.moveToFirst()){
            do {
                ...
                student.setCollegeName(cursor.getString(cursor.getColumnIndex(STUDENT_COLLEGE)));
                student.setPhoneNumber(cursor.getLong(cursor.getColumnIndex(STUDENT_PHONE_NUMBER)));
                student.setFees(cursor.getInt(cursor.getColumnIndex(STUDENT_FEES)));
    ...
    public int updateIndividualStudentDetails(Student student) {
        ...
        values.put(STUDENT_COLLEGE, student.getCollegeName());
        values.put(STUDENT_PHONE_NUMBER, student.getPhoneNumber());
        values.put(STUDENT_FEES, student.getFees());
        // updating row
